    ...
    IIdentityDbContext
{
    ...
    public DbSet<LeaveRequestApprovalLog> LeaveRequestApprovalLogs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        /* 🔥 KÍCH HOẠT FILE EXTENSION: Toàn bộ bảng HRM được cấu hình tại đây */
        builder.ConfigureHrm();
    }
}
