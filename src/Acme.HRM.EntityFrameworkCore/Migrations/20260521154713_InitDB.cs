        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxCarryDays = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingDays = table.Column<int>(type: "integer", maxLength: 100, nullable: false),
                    IsDefault = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkSchedules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInAt = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    CheckOutAt = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    ...
                    ExplainNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ExplainStatus = table.Column<int>(type: "integer", nullable: true),
                    ExplainApprovedBy = table.Column<long>(type: "bigint", nullable: true),
                    OtMinutes = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ScheduleId1 = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppAttendances_AppWorkSchedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractType = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: true),
                    BasicSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    InsuranceSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    DepartmentId1 = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppPositions_AppDepartments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    DepartmentId1 = table.Column<long>(type: "bigint", nullable: false),
                    PositionId1 = table.Column<long>(type: "bigint", nullable: false),
                    ManagerId1 = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppEmployees_AppEmployees_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewDepartmentId = table.Column<long>(type: "bigint", nullable: false),
                    OldPositionId = table.Column<long>(type: "bigint", nullable: true),
                    NewPositionId = table.Column<long>(type: "bigint", nullable: false),
                    OldBaseSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    NewBaseSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmployeeJobHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEmployeeJobHistories_AppEmployees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarriedOverDays = table.Column<decimal>(type: "numeric", nullable: false),
                    PendingDays = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    EmployeeId1 = table.Column<long>(type: "bigint", nullable: false),
                    LeaveTypeId1 = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDeduction = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Pit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    BhxhEmployee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    BhytEmployee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    BhtnEmployee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPayrolls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPayrolls_AppEmployees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AppEmployees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AppLeaveRequestApprovalLogs",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ActionStep = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLeaveRequestApprovalLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLeaveRequestApprovalLogs_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppLeaveRequestApprovalLogs_AppLeaveRequests_LeaveRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    PayrollId1 = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPayrollItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPayrollItems_AppPayrolls_PayrollId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAttendances_EmployeeId_WorkDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAttendances_ScheduleId",
                table: "AppAttendances",
                column: "ScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppContracts_EmployeeId",
                table: "AppContracts",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDepartments_ManagerId",
                table: "AppDepartments",
                column: "ManagerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEmployeeJobHistories_EmployeeId",
                table: "AppEmployeeJobHistories",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEmployees_ManagerId",
                table: "AppEmployees",
                column: "ManagerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLeaveRequestApprovalLogs_LeaveRequestId",
                table: "AppLeaveRequestApprovalLogs",
                column: "LeaveRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLeaveRequestApprovalLogs_UserId",
                table: "AppLeaveRequestApprovalLogs",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPayrollItems_PayrollId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPositions_DepartmentId",
                table: "AppPositions",
                column: "DepartmentId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AppContracts_AppEmployees_EmployeeId",
                table: "AppContracts",
                column: "EmployeeId",
                principalTable: "AppEmployees",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AppDepartments_AppEmployees_ManagerId",
                table: "AppDepartments",
                column: "ManagerId",
                principalTable: "AppEmployees",
                principalColumn: "Id",
