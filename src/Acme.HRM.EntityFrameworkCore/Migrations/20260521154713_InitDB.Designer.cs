...
namespace Acme.HRM.Migrations
{
    ...
    [Migration("20260521154713_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Attendance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<TimeOnly?>("CheckInAt")
                        .HasColumnType("time without time zone");

                    b.Property<TimeOnly?>("CheckOutAt")
                        .HasColumnType("time without time zone");
                    ...
                    b.Property<long?>("ExplainApprovedBy")
                        .HasColumnType("bigint");

                    b.Property<string>("ExplainNote")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<int?>("ExplainStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Contract", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Department", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Employee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.EmployeeJobHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppEmployeeJobHistories", (string)null);
                });

            modelBuilder.Entity("Acme.HRM.Entities.EmployeeProject", b =>
                {
                    b.Property<long>("EmployeeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.LeaveBalance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.LeaveRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.LeaveRequestApprovalLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppLeaveRequestApprovalLogs", (string)null);
                });

            modelBuilder.Entity("Acme.HRM.Entities.LeaveType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Payroll", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppPayrolls", (string)null);
                });

            modelBuilder.Entity("Acme.HRM.Entities.PayrollItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppPayrollItems", (string)null);
                });

            modelBuilder.Entity("Acme.HRM.Entities.Position", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Project", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.HRM.Entities.WorkSchedule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppWorkSchedules", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Attendance", b =>
                {
                    b.HasOne("Acme.HRM.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.WorkSchedule", null)
                        .WithMany()
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.WorkSchedule", "Schedule")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Department", b =>
                {
                    b.HasOne("Acme.HRM.Entities.Employee", "Manager")
                        .WithMany()
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Acme.HRM.Entities.Department", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.HRM.Entities.Employee", b =>
                {
                    b.HasOne("Acme.HRM.Entities.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.Department", "Department")
                        .WithMany()
                    ...
                    b.HasOne("Acme.HRM.Entities.Position", null)
                        .WithMany()
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.Position", "Position")
                        .WithMany()
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("Acme.HRM.Entities.Employee", "UserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Acme.HRM.Entities.EmployeeProject", b =>
                {
                    ...
                    b.HasOne("Acme.HRM.Entities.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.HRM.Entities.LeaveBalance", b =>
                {
                    ...
                    b.HasOne("Acme.HRM.Entities.LeaveType", null)
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.HRM.Entities.LeaveRequestApprovalLog", b =>
                {
                    b.HasOne("Acme.HRM.Entities.LeaveRequest", "LeaveRequest")
            ...
            modelBuilder.Entity("Acme.HRM.Entities.PayrollItem", b =>
                {
                    b.HasOne("Acme.HRM.Entities.Payroll", null)
                        .WithMany("Items")
                        .HasForeignKey("PayrollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.HRM.Entities.Payroll", "Payroll")
                        .WithMany()
